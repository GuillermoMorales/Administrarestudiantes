...
@EnableJpaRepositories(basePackages = "com.uca.capas.administracion.repositories")
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.uca.capas.administracion.domain");
	...
	public DataSource dataSource(){
		 ...
		 */
		dataSource.setUrl("jdbc:postgresql://localhost:5432/administracionbd");
